            ...
            <SwiperSlide key={idx}>
              <div className="flex flex-col sm:flex-row sm:justify-between items-center gap-12">
                <div className="py-4">
                 ...
                 <Link to='/'> <h1>{nws.title}</h1>
                 </Link>
                  <div className="bg-primary w-10 h-1 my-3"></div>
                  <p className="text-sm text-gray-600"> {nws.description}</p>
                
              </div>
              <div className="flex-shrink-0">
                <img src={nws.image} alt="pic" className="w-full object-cover" />
              </div>
              </div>
            </SwiperSlide>
          ))}

  ...
  return (
    <div className="h-[calc(100vh-120px)] flex justify-center items-center border">
      <div className="w-full max-w-sm mx-auto bg-white shadow-md px-8 pt-6 pb-8 mb-4">
        <h2 className="font-semibold text-xl mb-4">Register</h2>
        ...
        <p className="align-baseline font-medium mt-4 text-sm">Already account? Please<Link to='/login' className="text-blue-500 hover:text-blue-700"> Login</Link></p>
        {/* google sign in  */}
       <div className="mt-4">
